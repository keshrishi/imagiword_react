...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        <p className='text-center max-w-xl mx-auto mt-5'>Unleash your creativiy with AI. Turn your imagination into visual art in seconds - just type ,
        ...
        <p className='mt-2 text-neutral-600'>Generated images from ImagiWord</p>
    </div>
  )
}
